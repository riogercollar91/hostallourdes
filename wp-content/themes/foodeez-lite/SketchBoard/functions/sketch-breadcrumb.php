...
class foodeez_lite_breadcrumb_class {
    ...
    function custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url()) . '/">' . __('Home', 'foodeez-lite') . '</a>';
    ...
    function simple_breadcrumb_case($der_post) {
        ...
        if (is_author()) {
            ...
            return __('Author', 'foodeez-lite') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'foodeez-lite') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'foodeez-lite');

        }

		if (is_404()) {            return __('Error 404', 'foodeez-lite');        }
...
$foodeez_lite_breadcumb = new foodeez_lite_breadcrumb_class();
